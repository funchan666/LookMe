...
final class PolicyViewController: LMViewController, WKNavigationDelegate {
    ...
    private var content: (title: String, symbol: String, body: String) { switch kind {
        ...
        case .about: return ("About LookMe", "sparkles", "LookMe is a visual social community for authentic profiles, live rooms, short videos and consent-based conversations. Direct communication unlocks only after both people independently choose to follow each other.\n\nVersion 1.0") }
    }
}
